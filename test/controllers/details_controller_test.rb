...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { input: @detail.input, memory: @detail.memory, result_id: @detail.result_id, state_id: @detail.state_id, time: @detail.time }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { input: @detail.input, memory: @detail.memory, result_id: @detail.result_id, state_id: @detail.state_id, time: @detail.time }
    assert_redirected_to detail_path(assigns(:detail))
  end
